...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <!-- Total Users Card -->
            <div class="bg-white overflow-hidden shadow-md border border-gray-200 rounded-lg">
                <div class="p-6">
            ...
            <div class="bg-white overflow-hidden shadow-md border border-gray-200 rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-lg font-semibold text-gray-700">Total Job Posts</h2>
            ...
            <div class="bg-white overflow-hidden shadow-md border border-gray-200 rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-lg font-semibold text-gray-700">Total Applications</h2>
                            <p class="text-3xl font-bold text-gray-800">{{ \App\Models\Application::count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Latest Users</h3>
